...
However, we again note that \texttt{TChem}'s lack of thread-safety implies that calculation of Jacobians for many thermo-chemical states is potentially much faster using \texttt{pyJac} as the calculations may be accelerated easily using OpenMP.
