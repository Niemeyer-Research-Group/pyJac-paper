...
The Jacobian entries $\mathcal{J}_{k+1,j+1}$ for a third-body enhanced reaction can be updated as:
{\allowdisplaybreaks \begin{IEEEeqnarray}{cCc}
...
In order to demonstrate the correctness and computational performance of the generated analytical Jacobian matrices, multiple chemical kinetic models were chosen as test cases, selected to represent a wide spectrum of sizes, classes of fuel species, and types of reaction rate pressure dependence formulations (e.g., falloff, Chebyshev, pressure log).\todo{cleanup this}
...
In addition, future versions of \texttt{pyJac} will include the option of assuming constant-volume combustion.
