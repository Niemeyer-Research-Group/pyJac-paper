...
\texttt{pyJac} requires the Python modules NumPy~\cite{Walt:2011aa}; optional dependencies include Numberjack~\cite{Hebrard:2010aa} with SCIP~\cite{Achterberg:2009aa} for the cache optimizer, and performance testing module additionally requires Cython~\cite{Behnel:2011aa}, Cantera~\cite{Goodwin:2014aa}, PyYAML~\cite{Simonov:2014aa}, and numdifftools~\cite{Brodtkorb:2015aa}.
