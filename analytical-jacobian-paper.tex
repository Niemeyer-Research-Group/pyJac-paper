...
To avoid this limitation \texttt{pyJac} splits the CUDA Jacobian into several smaller subfiles, which are compiled separately.
...
In order to demonstrate the correctness and computational performance of the generated analytical Jacobian matrices, multiple chemical kinetic models were chosen as test cases, selected to represent a wide spectrum of sizes, classes of fuel species, and types of reaction rate pressure dependence formulations (e.g., falloff, Chebyshev, pressure log).
