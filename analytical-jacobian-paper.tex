...
This formulation encourages has two advantages.
First, as each species rate update for a reaction is independent they can be run with no chance of stalls due to data dependence.
Additionally, as the net reaction rate is used between multiple update steps it is highly likely to be found in the local L1 cache.
...
However, even use of a small number of shared memory cache spots can provide accelerations.
