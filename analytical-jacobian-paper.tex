...
During testing, it became apparent that \texttt{TChem} is not thread-safe when parallelized with OpenMP, for convenience a self-contained testing package can be found at this paper's \href{https://github.com/Niemeyer-Research-Group/pyJac-paper}{Github repository}.
