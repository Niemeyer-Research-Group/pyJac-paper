...
The CPU performance of \texttt{pyJac} is compared to the existing \texttt{TChem} package~\cite{Safta:2011vn} in Fig.~\ref{F:cpu_perf}.
...
This result challenges the assumption that hard-coded and compiled subroutines will outperform a loop\slash branch-based solution.
