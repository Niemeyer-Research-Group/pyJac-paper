...
{\allowdisplaybreaks \begin{IEEEeqnarray}{rCl}
\mathcal{J}_{k+1,j+1} &\pluseq& \frac{\nu_{ki}W_k}{W_j} \left[ T_{\partial Y,i,\text{ind}} \left( 1 - \frac{W_j}{W_{\numsp}} \right) +  c_i \left( k_{f,i} \left( S_j^{\prime} - S_{\numsp}^{\prime} \right) \right. \right. \nonumber \\
&& -\: \left. \left.
  k_{r,i} \left( S_j^{\prime\prime} - S_{\numsp}^{\prime\prime} \right) \right) \right] \quad
  k, j = 1, \ldots, \numsp
