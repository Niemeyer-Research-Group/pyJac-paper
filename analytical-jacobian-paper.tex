...
In addition to producing the necessary customized source code for evaluating reaction rates (including all modern reaction rate formulations), the chemical source terms, and the Jacobian matrix, pyJac uses an optimized evaluation order to minimize computational and memory operations.
...
\ce{H2}\slash \ce{CO}~\cite{Burke:2011fh}, 13 species and 27 reversible reactions
...
%Merchant butanol~\cite{Merchant:2013kz,Hansen:2013fe}, 372 species and 8723 reversible reactions
