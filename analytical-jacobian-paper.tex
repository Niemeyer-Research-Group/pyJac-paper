...
Typically, these are calculated numerically using finite differences, but this poses significant computational demands for larger mechanisms since the number of source term evaluations scales with the square of species count; existing analytical Jacobian tools do not optimize evaluations or support the emerging SIMD processors such as GPUs.
