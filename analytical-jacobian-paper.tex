...
During testing, it became apparent that \texttt{TChem} is not thread-safe when parallelized with OpenMP, for convenience a self-contained demonstration of this can be found at this paper's \href{https://github.com/Niemeyer-Research-Group/pyJac-paper/tree/master/tchem_multithread_test}{Github repository}.
