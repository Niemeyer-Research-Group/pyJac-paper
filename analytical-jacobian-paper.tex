...
The CPU Jacobian was compiled using \texttt{gcc} 4.4.7~\cite{gcc-4.4.7}, and run using two six-core Xeon X5650 processors.
...
The GPU Jacobian was tested on a single NVIDIA Tesla C2075, and was compiled using \texttt{nvcc} 7.5.17~\cite{cuda-7.5}.
